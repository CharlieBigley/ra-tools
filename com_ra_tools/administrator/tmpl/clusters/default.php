...
if (!empty($saveOrder))
{
	$saveOrderingUrl = 'index.php?option=com_ra_tools&task=clusters.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
						...
						<tr class="row<?php echo $i % 2; ?>" data-draggable-group='1' data-transition>
							...
							<td>
								<?php if (isset($item->checked_out) && $item->checked_out && ($canEdit || $canChange)) : ?>
									<?php echo HTMLHelper::_('jgrid.checkedout', $i, $item->uEditor, $item->checked_out_time, 'clusters.', $canCheckin); ?>
								<?php endif; ?>
								<?php if ($canEdit) : ?>
